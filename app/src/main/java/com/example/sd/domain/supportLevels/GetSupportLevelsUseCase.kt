package com.example.sd.domain.supportLevels
...
class GetSupportLevelsUseCase  @Inject constructor(private val repository: AppRepository) {
    ...
    operator fun invoke(): Flow<Resource<GetBidPriorities>> =
        flow {
            try {
                ...
                val response: GetBidPriorities = repository.getSupportLevels()
