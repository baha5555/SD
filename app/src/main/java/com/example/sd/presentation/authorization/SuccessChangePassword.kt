...
@Composable
fun SuccessChangePassword(navController: NavController) {
            ...
            Column(
                ...
                Image(
                    modifier = Modifier
                        .width(250.dp)
                        .height(200.dp),
                    bitmap = ImageBitmap.imageResource(R.drawable.icon_lockk),
                ...
                Text(
                    ...
                    text = "Вы успешно обновили свой пароль, теперь он будет запрашиваться при входе в приложение",
                    style = TextStyle(
                        fontSize = 14.sp,
                        lineHeight = 20.sp,
                        fontFamily = FontFamily(Font(R.font.inter)),
                ...
                Button(
                    onClick = {
                        navController.navigate("AnalysisScreen") {
                            popUpTo("SuccessChangePassword") { inclusive = true }
                        }
                    },
